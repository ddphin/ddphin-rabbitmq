...
public class RabbitmqCommonTxMessageSenderImpl
    ...
    public RabbitmqCommonTxMessageSenderImpl(
        ...
        this.script_mq_save_prepare.setScriptSource(new ResourceScriptSource(resourceLoader.getResource(
                "classpath:lua/mq_save_prepare.lua")));

        this.script_mq_move_prepare_to_do = new DefaultRedisScript<>();
        this.script_mq_move_prepare_to_do.setResultType(Long.class);
        this.script_mq_move_prepare_to_do.setScriptSource(new ResourceScriptSource(resourceLoader.getResource(
                "classpath:lua/mq_move_prepare_to_do.lua")));

        this.script_mq_remove_prepare = new DefaultRedisScript<>();
        this.script_mq_remove_prepare.setResultType(Long.class);
        this.script_mq_remove_prepare.setScriptSource(new ResourceScriptSource(resourceLoader.getResource(
                "classpath:lua/mq_remove_prepare.lua")));

        this.script_mq_remove_do = new DefaultRedisScript<>();
        this.script_mq_remove_do.setResultType(Long.class);
        this.script_mq_remove_do.setScriptSource(new ResourceScriptSource(resourceLoader.getResource(
                "classpath:lua/mq_remove_do.lua")));
        ...
        this.script_mq_move_do_to_redo_with_id.setScriptSource(new ResourceScriptSource(resourceLoader.getResource(
                "classpath:lua/mq_move_do_to_redo_with_id.lua")));

        this.script_mq_save_death = new DefaultRedisScript<>();
        this.script_mq_save_death.setResultType(Long.class);
        this.script_mq_save_death.setScriptSource(new ResourceScriptSource(resourceLoader.getResource(
                "classpath:lua/mq_save_death.lua")));

        this.script_mq_move_redo_to_do = new DefaultRedisScript<>();
        this.script_mq_move_redo_to_do.setResultType(String.class);
        this.script_mq_move_redo_to_do.setScriptSource(new ResourceScriptSource(resourceLoader.getResource(
                "classpath:lua/mq_move_redo_to_do.lua")));
        ...
        this.script_mq_move_do_to_redo_with_timestamp.setScriptSource(new ResourceScriptSource(resourceLoader.getResource(
                "classpath:lua/mq_move_do_to_redo_with_timestamp.lua")));

        this.script_mq_move_prepare_to_death = new DefaultRedisScript<>();
        this.script_mq_move_prepare_to_death.setResultType(Long.class);
        this.script_mq_move_prepare_to_death.setScriptSource(new ResourceScriptSource(resourceLoader.getResource(
                "classpath:lua/mq_move_prepare_to_death.lua")));
    }

    private Long script_mq_save_prepare(CorrelationDataRedis data) {
        return (Long) redisHelper.redis().execute(
    ...
    private String script_mq_move_redo_to_do() {
        return (String) redisHelper.redis().execute(
